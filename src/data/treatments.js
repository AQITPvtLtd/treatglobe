...
export const treatment = [
  ...
  //   ],
  //   content:
  //     "Neurosurgery is a medical specialty focusing on the surgical treatment of disorders affecting the nervous system, including the brain, spine, and peripheral nerves. It involves intricate procedures to address conditions such as brain tumors, aneurysms, spinal disorders, and trauma. CyberKnife is an advanced, non-invasive radiosurgery technology used in neurosurgery. It delivers precise, high-dose radiation to tumors and lesions in the brain and spine, minimizing damage to surrounding healthy tissue. This technology enhances treatment accuracy and is particularly beneficial for patients with inoperable or surgically complex tumors. Together, neurosurgery and CyberKnife offer cutting-edge solutions for neurological conditions.",
  // },
  // {
  //   id: 4,
  //   name: "treatments:four",
  ...
  //   ],
  //   content:
  //     "Transplant surgery involves replacing a diseased or failing organ with a healthy one from a donor. This field addresses conditions where organ function is severely impaired and other treatments are ineffective. Common transplants include kidney, liver, heart, lung, and pancreas. Surgeons perform these complex procedures, requiring precision and expertise to connect blood vessels and tissues. Post-surgery, patients must take immunosuppressive medications to prevent rejection of the new organ. Transplant surgery offers life-saving solutions and significantly improves the quality of life for patients with end-stage organ failure.",
  // },
];
